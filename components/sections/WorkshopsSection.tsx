  ...
  return (
    <section id="talleres" className="mx-auto max-w-7xl scroll-mt-20 px-4 py-20 sm:px-6 lg:px-8">
      ...
      {catalog.isLoading ? <p role="status" className="rounded-3xl bg-[var(--surface)] p-10 text-center">Cargando talleres…</p>
        ...
        : <div className="rounded-3xl border border-[color:var(--ink)]/10 bg-[#D1D3E8]/35 p-10 text-center"><h3 className="font-serif text-2xl">Próximos talleres</h3><p className="mt-3 text-sm">Pronto compartiremos nuestros talleres y horarios disponibles.</p></div>}
      <div className="mt-8 flex flex-wrap items-center justify-between gap-5 rounded-3xl bg-[#B2C9DC]/40 p-6 sm:p-8">
        ...
        <span className="rounded-full bg-[var(--surface)]/70 px-4 py-2 text-sm font-semibold">Agotados</span>
      </div>
    </section>
  );
}
